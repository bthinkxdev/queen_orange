...
urlpatterns = [
    ...
    path("payment/verify/", views.RazorpayPaymentVerifyView.as_view(), name="payment_verify"),
    ...
    path("payment/webhook/razorpay/", views.RazorpayWebhookView.as_view(), name="razorpay_webhook"),
