...
urlpatterns = [
    ...
    path("products/<int:pk>/variants/add/", admin_views.ProductVariantAddApiView.as_view(), name="product_variant_add"),
    ...
    path("variants/<int:variant_id>/sizes/add/", admin_views.VariantAddSizeApiView.as_view(), name="variant_add_size"),
    path("size/<int:pk>/update-stock/", admin_views.SizeVariantUpdateStockView.as_view(), name="size_update_stock"),
    path("images/<int:image_id>/delete/", admin_views.ProductImageDeleteView.as_view(), name="product_image_delete"),
    path("images/<int:image_id>/replace/", admin_views.ProductImageReplaceView.as_view(), name="product_image_replace"),
    path("products/<int:pk>/jewellery-detail/", admin_views.ProductJewelleryDetailApiView.as_view(), name="product_jewellery_detail"),
    path("products/<int:pk>/jewellery-upload-image/", admin_views.JewelleryUploadImageView.as_view(), name="jewellery_upload_image"),
    path("jewellery-images/<int:image_id>/delete/", admin_views.JewelleryImageDeleteView.as_view(), name="jewellery_image_delete"),
    path("jewellery-images/<int:image_id>/replace/", admin_views.JewelleryImageReplaceView.as_view(), name="jewellery_image_replace"),
